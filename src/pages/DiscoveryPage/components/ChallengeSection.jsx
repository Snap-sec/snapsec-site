  ...
  return (
    <div className="section-platform-challenge">
      <div className="container bg-white">
        <div className="section-platform-challenge__wrapper relative flex flex-col gap-lg overflow-hidden border-x-[0.5px] border-gray-600 px-sm sm:px-xl lg:gap-88px lg:px-80px">
          <h2 className="heading-hero2 mx-auto w-full max-w-[632px] text-center">The Challenge</h2>
