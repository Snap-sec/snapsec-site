    ...
    <div className="section-visibility-integration">
      <div className="container bg-white">
        <div className="section-visibility-integration__wrapper relative flex flex-col gap-lg overflow-hidden border-x-[0.5px] border-t-[0.5px] border-gray-600 px-sm pb-xs pt-xxl sm:px-xl lg:gap-lg lg:px-80px lg:pb-64px lg:pt-88px">
          <div className="section-visibility-integration__heading flex flex-col gap-lg lg:flex-row lg:items-start lg:justify-between">
            <div className="flex w-full flex-col gap-sm lg:max-w-[524px]">
              ...
              <p className="subtitle-m w-full lg:max-w-[416px]">Integrates seamlessly and gathers vital information from various systems and tools</p>
            </div>
          ...
          <div className="section-visibility-integration__content flex flex-col gap-sm lg:flex-row lg:items-center lg:gap-140px">
            <div className="section-visibility-integration__info flex w-full flex-col gap-md lg:max-w-[352px]">
