    ...
    <section className="cta-banner-small">
      <div className="container">
        <FadeInBlock>
          ...
          >
            {/* Decorative conic gradient overlay (desktop) */}
            <div
              className="absolute inset-0 z-1 hidden lg:block"
              style={{
                background: 'conic-gradient(from 92.06deg at 48.62% 114.48%, rgba(255,255,255,0) -135.77deg, rgba(255,255,255,0) 183.44deg, #004DFF 187.2deg, #FFFFFF 190.98deg, #004DFF 197.74deg, #000000 205.59deg, rgba(255,255,255,0) 224.23deg, rgba(255,255,255,0) 543.44deg)',
                maskImage: 'conic-gradient(from 92.06deg at 48.62% 114.48%, rgba(255,255,255,0) -135.77deg, rgba(255,255,255,0) 183.44deg, #004DFF 187.2deg, #FFFFFF 190.98deg, #004DFF 197.74deg, #000000 205.59deg, rgba(255,255,255,0) 224.23deg, rgba(255,255,255,0) 543.44deg)',
                transform: 'scaleX(-1)',
                pointerEvents: 'none',
              }}
            />
            ...
            <div className="relative z-5 mx-auto flex w-full flex-col gap-lg text-center max-w-[800px]">
              <h3 className="heading-h1">
                <span>Gain Full Visibility and Security for All Non-Human Identities</span>
              </h3>
              <div>
                <a className="group button-primary-m" href="/book-demo">
