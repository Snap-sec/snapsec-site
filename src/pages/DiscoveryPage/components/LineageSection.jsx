        ...
        <div className="container bg-white">
          ...
          <div className="section-visibility-identity__image w-full border-x-[0.5px] border-gray-600 pt-xxl lg:pt-88px">
            <span className="block" style={{opacity: 1}}>
              <img alt="Identity Lineage™ Comprehensive NHI Contextualization" loading="lazy" width="2246" height="958" decoding="async" data-nimg="1" className="w-full" style={{color: 'transparent'}} srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fvisibility-identity-image.310ce7bf.png&amp;w=3840&amp;q=75&amp;dpl=dpl_HdUvuAVMUSwcPVPp3UAoCb9Pan5s 1x" src="/_next/static/media/visibility-identity-image.310ce7bf.png" />
            </span>
          </div>
        </div>
      </div>
